...
(__VLS_ctx.title || 'Körperfett-Rechner');
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.input)({
    ...{ onInput: (__VLS_ctx.onWaistInput) },
    value: (__VLS_ctx.waist ?? ''),
    type: "number",
    placeholder: "z.B. 80",
    ...{ class: "edit-input" },
});
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.label, __VLS_intrinsicElements.label)({});
__VLS_asFunctionalElement(__VLS_intrinsicElements.input)({
    ...{ onInput: (__VLS_ctx.onNeckInput) },
    value: (__VLS_ctx.neck ?? ''),
    type: "number",
    placeholder: "z.B. 38",
    ...{ class: "edit-input" },
});
if (__VLS_ctx.gender === 'female') {
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
        ...{ class: "input-group" },
    });
    __VLS_asFunctionalElement(__VLS_intrinsicElements.label, __VLS_intrinsicElements.label)({});
    __VLS_asFunctionalElement(__VLS_intrinsicElements.input)({
        ...{ onInput: (__VLS_ctx.onHipInput) },
        value: (__VLS_ctx.hip ?? ''),
        type: "number",
        placeholder: "z.B. 90",
        ...{ class: "edit-input" },
...
const __VLS_self = (await import('vue')).defineComponent({
    setup() {
        return {
            ...
            onWaistInput: onWaistInput,
            onNeckInput: onNeckInput,
            onHipInput: onHipInput,
