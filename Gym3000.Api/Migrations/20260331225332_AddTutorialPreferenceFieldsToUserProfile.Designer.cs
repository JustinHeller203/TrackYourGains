...
namespace Gym3000.Api.Migrations
{
    ...
    [Migration("20260331225332_AddTutorialPreferenceFieldsToUserProfile")]
    partial class AddTutorialPreferenceFieldsToUserProfile
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Gym3000.Api.Entities.ComplaintEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Gym3000.Api.Entities.TrainingPlanSchedule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("TrainingPlanSchedules");
                });

            modelBuilder.Entity("Gym3000.Api.Entities.TrainingRestDay", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Gym3000.Api.Entities.UserProfile", b =>
                {
                    ...
                    b.Property<string>("TutorialFavoriteIdsJson")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("TutorialRecentViewedJson")
                        .IsRequired()
                        .HasColumnType("text");
